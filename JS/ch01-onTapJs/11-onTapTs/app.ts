...
// string
let car = "Toyota";
let bike: string; //khai báo biến và chưa sử dụng tương đương khai báo string car
bike = "Winner";
// bike = 150 Loi ngay

// number
let num: number = 10; // khai báo và khởi tạo
//nhưng khi gán value thì ts đã kty kiểu dl rồi nên ko cần gán kdl
...
// any là có thể gán cho nó bằng bki kiểu dữ liệu nào
// let person: any
// person = 10
// person = 'Something'
// person = false
